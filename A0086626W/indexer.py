...
def build(index_directory, dictionary_file, postings_file):
    ...
    write_meta_data_to_disk(doc_lengths, len(files_to_index), doc_top_terms, UPC_class, IPC_class, family_members)
...
def write_meta_data_to_disk(doc_lengths, num_docs, doc_top_terms, UPC_class, IPC_class, family_members):
    f = open(META_DATA,'w')
